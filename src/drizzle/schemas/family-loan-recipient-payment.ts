...
export const familyLoanRecipientPaymentRelation = relations(familyLoanRecipientPaymentTable, ({ one }) => ({
    ...
    receiveBank: one(familyBankAccountsTable, {
        fields: [familyLoanRecipientPaymentTable.familyReceiveBankId],
